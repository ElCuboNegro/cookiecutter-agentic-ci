...
1. **Reverse Engineering & Analysis**: If asked to reverse engineer, analyze, GENERATE THE EXECUTIONS GRAPH, or BACKTRACK the template or hooks, you MUST read/activate `.agents/skills/software-archeologist/SKILL.md`.
